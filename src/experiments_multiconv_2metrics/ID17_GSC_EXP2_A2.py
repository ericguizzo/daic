...
short_description = 'GSC 1 conv 10 channel'
dataset = 'gsc_stft'
...
global_parameters = ['fc_insize=142520', 'channels=10', 'architecture="CNN_1conv"',
                     'output_classes=36', 'kernel_size_1=[5,5]', 'batch_size=300']

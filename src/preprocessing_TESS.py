...
def main():
    ...
    predictors_save_path = os.path.join(OUTPUT_FOLDER, 'tess' + appendix + '_predictors.npy')
    target_save_path = os.path.join(OUTPUT_FOLDER, 'tess' + appendix + '_target.npy')

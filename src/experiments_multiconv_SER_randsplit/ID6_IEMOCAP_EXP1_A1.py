...
short_description = 'IEMOCAP 1 conv 1 channel'
dataset = 'iemocap_randsplit_stft'
...
global_parameters = ['fc_insize=59553', 'channels=1', 'architecture="CNN_1conv"',
                     'output_classes=4', 'batch_size=100']
...
experiment[5] = ['comment_1="multi,reg:0.0"', 'comment_2="(0.7, 1.),(1.428,1.)"',
                 'architecture="CNN_1conv"', 'reshaping_type="cnn"',
                 'regularization_lambda=0.0',
                 'layer_type="multi"', 'kernel_size_1=[10,5]', 'channels=1',
                 'learning_rate=0.001', 'output_classes=8', 'num_epochs=100',

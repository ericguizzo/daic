...
short_description = 'EMODB 1 conv 1 channel'
dataset = 'emodb_randsplit_stft'
...
global_parameters = ['fc_insize=138448', 'channels=1', 'architecture="CNN_1conv"',
                     'output_classes=7', 'batch_size=100']

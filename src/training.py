...
def main():
    ...
    if generator:
        ...
        train_pred = best_model.predict_generator(training_generator, steps=1)
        val_pred = best_model.predict_generator(validation_generator, steps=1)
        test_pred = best_model.predict_generator(test_generator, steps=1)
    else:
